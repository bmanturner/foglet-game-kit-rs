...
- [x] **11d** — Update install docs with writable `world/` permissions and backup notes. [11a]

### Task 12 — Murder Motel shared Room 7

- [x] **12a** — Add Murder Motel migration for `motel_world_state` key/value table. [4b]
- [x] **12b** — Record `room_7_opened_at` and opener player id when first player unlocks Room 7. [12a, 5b]
- [x] **12c** — Show later players that Room 7 was already opened by someone else. [12b]
- [x] **12d** — Add two-player test: Alice opens Room 7, Bob sees shared evidence. [12c]
...
- [x] **13d** — Add lobby bulletin/ledger screen that lists recent events. [7c]
